    ...
    <li>
      <Link to={'/'}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-around', width: '6rem' }}>
          ...
          <li className='p-3 rounded-sm hover:bg-accent/20 font-bold leading-relaxed tracking-wide' onClick={togglePopUp}><div href="">
            ...
            <div className='absolute flex flex-col w-1/12 items-center border border-primary bg-accent/20 text-background right-8 top-24 p-3 rounded-sm hover:bg-accent/20 font-bold leading-relaxed tracking-wide z-40' style={{ display: popUpDisplay }}>
              ...
              <div className='cursor-pointer hover:bg-primary/20 text-text/80 rounded-sm py-2 z-50' /*onClick={handleLogout}*/>Profile</div>
              <div className='cursor-pointer hover:bg-primary/20 rounded-sm text-text/80 py-2 z-50' /*onClick={handleLogout}*/>Logout</div>
