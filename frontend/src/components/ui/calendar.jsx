...
function Calendar({
  ...
  return (
    (<DayPicker
      ...
      // className={cn("p-3 bg-secondary/25 backdrop-blur-2xl backdrop-brightness-150 rounded-md", className)}
      className={cn("p-3", className)}
      classNames={{
        months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4 bg-transparent",
        // month: "space-y-4",
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent text-background border-background p-0 opacity-50 hover:opacity-100"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-medium bg-secondary/70 aria-selected:opacity-100"
        ),
